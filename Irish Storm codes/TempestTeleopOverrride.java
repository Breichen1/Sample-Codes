...
@TeleOp(name = "TempestTeleopOverride")
public class TempestTeleopOverrride extends LinearOpMode {
...
//speed for all superstructure motors
    ...
    //Soft limits
     //Soft limits
    static final int ArmLimit = -100000;
    static final int JointLimit = 100000;
...
//Integer calls for setpoint
  ...
  public void runOpMode() {
    ...
    liftmotor = hardwareMap.get(DcMotor.class, "elevator motor");
    ...
    extensionservo = hardwareMap.get(CRServo.class, "arm extension");
    topservo = hardwareMap.get(Servo.class, "wrist servo");
    rightservo = hardwareMap.get(Servo.class, "right claw servo");
    leftservo = hardwareMap.get(Servo.class, "left claw servo");
